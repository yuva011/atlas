...
Config.JobGarageLocations = { -- IMPORTANT - Every garage name must be unique
  ...
  ["Police"] = {
    coords = vector3(441.38, -951.03, 21.44),
    spawn = {
      vector4(444.51, -960.88, 21.44, 272.13),
      vector4(437.72, -961.02, 21.44, 85.04),
      vector4(444.45, -963.76, 21.44, 266.46),
      vector4(437.56, -964.11, 21.44, 87.87),
      vector4(445.27, -968.64, 21.44, 269.29),
      vector4(437.89, -968.77, 21.44, 82.20),
      vector4(444.55, -971.70, 21.44, 266.46),
      vector4(438.07, -971.68, 21.44, 85.04),
      vector4(428.20, -960.99, 21.44, 266.46),
      vector4(427.48, -964.05, 21.44, 269.29),
      vector4(421.38, -960.86, 21.44, 87.87),
      vector4(421.07, -964.29, 21.44, 87.87),
    },
    distance = 15,
      job = {"sasp","bcso","lspd","saspr"},
    type = "car",
    hideBlip = false,
    blip = {
      id = 357,
    ...
    vehicles = {
      [1] = { model = "onx_polbuffhf", plate = false, minJobGrade = 0, maxMods = true, livery = 1 },
      [2] = { model = "onx_polmonar", plate = false, minJobGrade = 0, maxMods = true, livery = 1 },
      [3] = { model = "onx_polscout", plate = false, minJobGrade = 0, maxMods = true, livery = 1 },
      [4] = { model = "onx_polterm2", plate = false, minJobGrade = 0, maxMods = true, livery = 1 },
      [5] = { model = "onx_polinvict2", plate = false, minJobGrade = 0, maxMods = true, livery = 1 },
      [6] = { model = "onx_polkandra", plate = false, minJobGrade = 0, maxMods = true, livery = 1 },
      [7] = { model = "onx_poldom", plate = false, minJobGrade = 0, maxMods = true, livery = 1 },
      [8] = { model = "onx_polvstr", plate = false, minJobGrade = 0, maxMods = true, livery = 1 },
      [9] = { model = "onx_polcoq", plate = false, minJobGrade = 0, maxMods = true, livery = 1 },
      [10] = { model = "onx_poljog", plate = false, minJobGrade = 0, maxMods = true, livery = 1 },
    }
  }
}
...
Config.ImpoundFeesSocietyFund = false -- Job name of society fund to pay impound fees into (optional)
